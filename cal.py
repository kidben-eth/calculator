...
Button(root, text="3", width=5, height=1, font=('arial', 30,"bold"), bd=1, fg="#fff",bg="#2a2d36", command=lambda: show("1")).place(x=10, y=400)
Button(root, text="2", width=5, height=1, font=('arial', 30,"bold"), bd=1, fg="#fff",bg="#2a2d36", command=lambda: show("2")).place(x=150, y=400)
Button(root, text="1", width=5, height=1, font=('arial', 30,"bold"), bd=1, fg="#fff",bg="#2a2d36", command=lambda: show("3")).place(x=290, y=400)
...
# Button(root, text="=", width=5, height=3, font=('arial', 30,"bold"), bd=1, fg="#fff",bg="#fe9037", command=lambda: caculator()).place(x=430, y=400)
